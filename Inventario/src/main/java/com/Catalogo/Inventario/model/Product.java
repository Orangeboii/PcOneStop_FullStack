...
public class Product {
    ...
    @Schema(description = "Cantidad disponible en inventario (opcional, por defecto 0, debe ser mayor o igual a 0)", example = "10", minimum = "0")
    ...
    public void setOffer(Map<String, Object> offer) {
        if (offer != null) {
            ...
            if (discountObj != null) {
                ...
                // Si hay descuento, activar la oferta automáticamente
                if (this.discount > 0) {
                    this.isOnSale = true;
                }
            }
            ...
            if (startDateObj != null) {
                ...
                // Si hay fecha de inicio, activar la oferta
                this.isOnSale = true;
            }
            ...
            if (endDateObj != null) {
                ...
                // Si hay fecha de fin, activar la oferta
                this.isOnSale = true;
            }
        }
    }
